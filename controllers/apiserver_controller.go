...
//+kubebuilder:rbac:groups=http.appscode.com,resources=apiservers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=http.appscode.com,resources=apiservers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=http.appscode.com,resources=apiservers/finalizers,verbs=update
...
func (r *ApiserverReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var apiserver httpv1alpha1.Apiserver
